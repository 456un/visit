...
<script>
import DesignItemComponent from "@/components/ui/DesignItemComponent.vue";
...
<template>
  <div class="desc">Как хобби, только в свободное время, 500 руб/ч.</div>
  <DesignItemComponent
      title="Сайт визитка (дизайн сделан в Figma)"
